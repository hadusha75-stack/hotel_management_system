...
<head>
    ...
    <title>Housekeeping — Sabawyan Hotel</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .update-form select {
            padding: 7px 12px; border: 1.5px solid #e0e0e0; border-radius: var(--radius-sm);
            font-size: 13px; font-family: 'Inter', sans-serif; background: #fafafa;
...
<main class="page">
    ...
    <div class="page-header">
        <h2><i class="fas fa-broom" style="color:#1abc9c;margin-right:10px;font-size:24px;"></i>Housekeeping Dashboard</h2>
        <p>View all rooms and update cleanliness status</p>
...
require_once __DIR__ . '/../auth/guard_staff.php';
        ...
        <div class="table-footer">
            ...
            <span class="footer-brand"><i class="fas fa-broom" style="margin-right:5px;"></i>Housekeeping</span>
        </div>
    </div>
